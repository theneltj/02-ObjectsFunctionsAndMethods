...
def try_methods_and_functions():
    ...
    ###########################################################################
    roger = rg.SimpleTurtle('triangle')
    roger.pen = rg.Pen('blue',5)
    roger.backward(150)
    roger.speed = 1
    draw_many_squares(roger,2,100,30)
    roger.speed = 5
    roger.pen = rg.Pen('red', 5)
    draw_many_squares(roger, 10, 50, 15)
    roger.speed = 100
    roger.pen = rg.Pen('red', 35)
    draw_many_squares(roger, 8, 300, 60)
    roger.pen = rg.Pen('black', 3)
    roger.backward(200)
    roger.draw_circle(30)
    roger.draw_square(50)
# -----------------------------------------------------------------------------
