...
def main():
    ...
    #even_better_draw_circles(rg.Point(200,200), 10, 5, 'blue', 4)
    #even_better_draw_circles(rg.Point(-200, 0), 20, 20, 'green', 15)

    even_better_draw_circles(rg.Point(200, 200), 10, 20, 'pink', 4)
    even_better_draw_circles(rg.Point(-200, 200), 10, 20, 'purple', 4)
    even_better_draw_circles(rg.Point(-200, -200), 10, 20, 'pink', 4)
    even_better_draw_circles(rg.Point(200, -200), 10, 20, 'purple', 4)
    even_better_draw_circles(rg.Point(0, 0), 10, 15, 'yellow', 8)
    window.update()
